...
const Clothes = (props) => {
  ...
  const [searchInput, setSearchInput] = useState('jacket')
  const [preSearch, setPreSearch] = useState('')
  const [searchCat, setSearchCat] = useState('11450')
  const itemArr = []
    ...
    return (
      <Col className='product_box' lg={12}>
        <section className="products" id="products">
          ...
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('15724')}>
            <p>Women</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('1059')}>
            <p>Men</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('260019')} >
            <p>Kids</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('260018')}>
            <p>Baby</p>
            </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('175759')}>
            <p>Vintage</p>
            </Button>
          </Col>
          </Container>
