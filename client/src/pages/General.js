...
const General = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(`https://svcs.ebay.com/services/search/FindingService/v1?OPERATION-NAME=findItemsByCategory&SERVICE-VERSION=1.0.0&SECURITY-APPNAME=SkyTexie-ReactECo-PRD-f9f3fcb9f-9fbc87f9&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD&categoryId=66502&paginationInput.entriesPerPage=25&outputSelector=CategoryHistogram`)
