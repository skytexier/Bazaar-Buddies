...
const Furniture = (props) => {
  ...
  const [searchCat, setSearchCat] = useState('3197')
  const itemArr = []
    ...
    return (
      <Col className='product_box' lg={12}>
        <section className="products" id="products">
          ...
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('16038')}>
            <p>Camping Furniture</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('25863')}>
            <p>Patio & Garden Furniture</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('11828')} >
            <p>Office Furniture</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('165252')}>
            <p>Collectibles</p>
            </Button>
