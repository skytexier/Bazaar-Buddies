...
const Motors = (props) => {
  ...
  const [searchCat, setSearchCat] = useState('6001')
  const itemArr = []
    ...
    return (
      <Col className='product_box' lg={12}>
        <section className="products" id="products">
          ...
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('6001')}>
            <p>Cars & Trucks</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('98060')}>
            <p>Race Cars (Not Street Legal)</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('6024')} >
            <p>Motorcycles</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('80765')}>
            <p>Military Vehicles</p>
            </Button>
            <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('66466')}>
            <p>Powersports</p>
            </Button>
          </Col>
          </Container>
