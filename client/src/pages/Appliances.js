...
const Appliances = (props) => {
  ...
  const [searchCat, setSearchCat] = useState('261709')
  const itemArr = []
    ...
    return (
      <Col className='product_box' lg={12}>
        <section className="products" id="products">
          ...
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('69197')}>
            <p>Heating, Cooling & Air </p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('20625')}>
            <p>Kitchen, Dining & Bar</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('261757')} >
            <p>Major Appliances</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('20710')}>
            <p>Major Appliances & Bathroom Fixtures</p>
          </Button>
          </Col>
          </Container>
