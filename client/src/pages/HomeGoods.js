...
const HomeGoods = (props) => {
  ...
  const [searchCat, setSearchCat] = useState('11700')
  const itemArr = []
    ...
    return (
      <Col className='product_box' lg={12}>
        <section className="products" id="products">
          ...
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('11700')}>
            <p>Home & Garden </p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('10033')}>
            <p>Home Décor</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('299')} >
            <p>Household Supplies & Cleaning</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('159907')}>
            <p>Home Improvement</p>
            </Button>
            <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('262975')}>
