...
const Antiques = (props) => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        `https://svcs.ebay.com/services/search/FindingService/v1?OPERATION-NAME=findItemsAdvanced&SERVICE-VERSION=1.0.0&SECURITY-APPNAME=SkyTexie-ReactECo-PRD-f9f3fcb9f-9fbc87f9&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD&paginationInput.entriesPerPage=25&keywords=${searchInput}&categoryId=${searchCat}&`,
        {
      ...
      const itemsList =
        newData.findItemsAdvancedResponse[0].searchResult[0].item;
      setItems(itemsList);
    } catch (error) {
      console.log(error);
    }
  ...
  if (items === undefined) {
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      obj["category"] = items[i].primaryCategory[0].categoryName[0].replace(
        "/thumbs/",
        ""
      );
        ...
        <Container className="subcategories">
          ...
          <Col className="categoryButtons d-flex">
            <Button
              ...
              variant="secondary"
              size="md"
              onClick={() => handleCategoryChange("4707")}
            >
            ...
            <Button
              ...
              variant="secondary"
              size="md"
              onClick={() => handleCategoryChange("20082")}
            >
              <p>Asian Antiques</p>
            </Button>
            <Button
              ...
              variant="secondary"
              size="md"
              onClick={() => handleCategoryChange("2207")}
            >
              <p>Ethnographic</p>
            </Button>
            <Button
              ...
              variant="secondary"
              size="md"
              onClick={() => handleCategoryChange("20091")}
            >
              <p>Furniture</p>
            </Button>
            <Button
              ...
              variant="secondary"
              size="md"
              onClick={() => handleCategoryChange("37958")}
            >
            ...
            <Button
              ...
              variant="secondary"
              size="md"
              onClick={() => handleCategoryChange("181726")}
            >
            ...
            <Button
              ...
              variant="secondary"
              size="md"
              onClick={() => handleCategoryChange("20094")}
            >
            ...
            <Button
              ...
              variant="secondary"
              size="md"
              onClick={() => handleCategoryChange("20096")}
            >
              <p>Silver</p>
            </Button>
          </Col>
