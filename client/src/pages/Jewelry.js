...
const Jewelry = (props) => {
  ...
  const [searchCat, setSearchCat] = useState('281')
  const itemArr = []
    ...
    return (
      <Col className='product_box' lg={12}>
        <section className="products" id="products">
          ...
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('261650')}>
            <p>Collectibles</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('10290')}>
            <p>Men's Jewelry </p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('262024')} >
            <p>Vintage & Antique Jewelry</p>
          </Button>
          <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('163873')}>
            <p>Entertainment Memorabilia</p>
            </Button>
            <Button className='subcategory' type='button' variant='secondary' size='md' onClick={() => handleCategoryChange('165670')}>
            <p>Religion & Spirituality Jewelry</p>
            </Button>
          </Col>
          </Container>
